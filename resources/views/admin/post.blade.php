                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-center" id="modalCenterTitle">Edit Post</h5>
                                                <button
                                                    type="button"
                                                    class="btn-close"
                                            ...
                                            <form action="{{route('posts.update', $post->id)}}" method="post">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col mb-3">
                                                            <label for="tile" class="form-label">Post Title</label>
                                                            <input
                                                                type="text"
                                                                id="tile"
                                                                name="title"
                                                                class="form-control @error('title') is-invalid @enderror"
                                                                plaslugceholder="Enter your post title"
                                                                value="{{$post->title}}"/>
                                                            @error('title')
