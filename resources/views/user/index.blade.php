            ...
            <div class="row justify-content-center">
                    ...
                    @foreach($posts as $post)
                        <article class="card mb-4">
                            <div class="post-slider">
                                <img src="{{asset('frontendAssets/images/post/post-1.jpg')}}" class="card-img-top" alt="post-thumb">
                            </div>
                            <div class="card-body">
                ...
                <aside class="col-lg-4 sidebar-home">
                    ...
                    <div class="widget">
                        ...
                        <article class="widget-card">
                            <div class="d-flex">
                                <img class="card-img-sm" src="{{asset('frontendAssets/images/post/post-1.jpg')}}">
                                <div class="ml-3">
                                    <h5><a class="post-title" href="post-details.html">Advice From a Twenty Something</a></h5>
                                    <ul class="card-meta list-inline mb-0">
                                        <li class="list-inline-item mb-0">
